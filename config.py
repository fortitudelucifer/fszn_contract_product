...
class Config:
    ...
    UPLOAD_FOLDER = os.path.join(BASE_DIR, 'fszn', 'uploads')
    ...
    WECOM_WEBHOOK_URL = "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=49d0a906-7e6c-4154-b061-7fa43ba15115"
#     企业id 
# wwa2c691c36d773a31
# 1000002
#     nmwl25QTxJxHIXlIufBsakzfPMzEMNqygERcZBIStR8
